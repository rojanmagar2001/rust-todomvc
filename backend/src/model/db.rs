...
const PG_ROOT_USER: &str = "admin";
const PG_ROOT_PWD: &str = "admin";

//app db
const PG_APP_DB: &str = "rusttodomvc";
const PG_APP_USER: &str = "admin";
const PG_APP_PWD: &str = "admin";
...
async fn new_db_pool(
    ...
    PgPoolOptions::new()
        ...
        .idle_timeout(Duration::from_millis(500)) // Needs to find replacement
        .connect(&con_string)
        .await
}
